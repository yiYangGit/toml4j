...
public class ErrorMessagesTest {
  ...
  public void invalid_table() throws Exception {
    e.expectMessage("Invalid table definition on line 1: [in ");
  ...
  public void empty_implicit_table_name() throws Exception {
    e.expectMessage("Invalid key on line 1: [a..b]");
    new Toml().read("[a..b]");
  }
  ...
  public void invalid_table_array() throws Exception {
    e.expectMessage("Invalid table array definition on line 1: [[in ");
  ...
  public void should_display_correct_line_number_with_literal_multiline_string() throws Exception {
    e.expectMessage("Invalid value on line 8: j = 4.");

      String tomlString = "[table]\n\n k = '''abc\n\ndef\n'''\n # comment \n j = 4.\n l = 5";
      System.out.println(tomlString);
      new Toml().read(tomlString);
  }
  
  @Test
  public void should_display_correct_line_number_with_multiline_string() throws Exception {
    e.expectMessage("Invalid value on line 9: j = 4.");
