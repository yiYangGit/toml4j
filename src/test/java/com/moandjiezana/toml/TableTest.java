...
public class TableTest {
  ...
  public void should_accept_table_name_part_with_basic_string() {
    Toml toml = new Toml().read("[target.\"cfg(unix)\".dependencies]\nb = 'b'");
      String string = toml.getTable("target").getTable("cfg(unix)").getTable("dependencies").getString("b");
  ...
  public void should_accept_table_name_part_with_whitespace_and_basic_string() {
    Toml toml = new Toml().read("[ target . \"cfg (unix)\" . dependencies ]\nb = 'b'");
      String str = toml.getTable("target").getTable("cfg (unix)").getTable("dependencies").getString("b");
      assertEquals("b", str);
  }
  ...
  public void should_accept_table_name_part_with_literal_string() {
    ...
    assertEquals("b", toml.getTable("target").getTable("cfg(unix)").getTable("dependencies").getString("b"));
  }
